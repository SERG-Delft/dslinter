...
class TestHyperparameterChecker(pylint.testutils.CheckerTestCase):
    ...
    def test_no_keywords(self):
        """Test whether a message is added when no keywords are present."""
        call_node = astroid.extract_node(
            """
            KMeans() #@
            """
    ...
    def test_missing(self):
        """Test whether a message is added when no hyperparameters are present."""
        call_node = astroid.extract_node(
            """
            KMeans(n_init=5) #@
            """
    ...
    def test_correct_keyword(self):
        """Test whether no message is added when the hyperparameters are present as keyword."""
        call_node = astroid.extract_node(
            """
    ...
    def test_correct_positional_argument(self):
        """Test whether no message is added when hyperparameters are present as positional args."""
        call_node = astroid.extract_node(
            """
            KMeans(5) #@
            """
    ...
    def test_strict_incorrect(self):
        """Test whether a message is added when not strictly all hyperparameters are added."""
        call_node = astroid.extract_node(
            """
            KMeans(n_clusters=5) #@
            """
    ...
    def test_strict_correct(self):
        """Test whether no message is added when strictly all hyperparameters are added."""
        call_node = astroid.extract_node(
            """
